-- =========================================================================
-- OPTIFLOTA - SCRIPT SQL COMPLETO (SaaS)
-- =========================================================================
...
-- 3. AUDITORÍA (NUEVA TABLA - CRÍTICA PARA SEGURIDAD)
CREATE TABLE logs_auditoria (
    id INT AUTO_INCREMENT PRIMARY KEY,
    id_usuario INT NOT NULL,
    id_empresa INT,
    accion VARCHAR(255) NOT NULL, -- Ej: "Subió comprobante de pago", "Dio de baja unidad ABC-1234"
    modulo VARCHAR(50) NOT NULL,  -- Ej: "Pagos", "Vehículos"
...
CREATE TABLE pagos_suscripcion (
    ...
    comprobante_url VARCHAR(255) NOT NULL, -- Ruta donde se guardará el PDF/JPG
...
CREATE TABLE vehiculos (
    ...
    estado VARCHAR(20) DEFAULT 'Activo', -- Activo, Taller, Inactivo (Borrado lógico)
...
CREATE TABLE diagnosticos (
    ...
    observaciones TEXT,
    reporte_url VARCHAR(255) NULL, -- NUEVO: Ruta para descargar el reporte PDF
    creado_por INT NOT NULL,
    creado_en TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (id_empresa) REFERENCES empresas(id),
...
CREATE TABLE cargas_combustible (
    ...
    origen_registro VARCHAR(50) DEFAULT 'Manual', -- NUEVO: 'Manual' o 'Importacion_Excel'
    creado_por INT NOT NULL,
    creado_en TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (id_empresa) REFERENCES empresas(id),
    FOREIGN KEY (id_vehiculo) REFERENCES vehiculos(id),
...
CREATE TABLE tickets (
    ...
    evidencia_url VARCHAR(255) NULL, -- NUEVO: Para fotos de siniestros
    estado VARCHAR(20) DEFAULT 'Pendiente', 
    creado_por INT NOT NULL,
    creado_en TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
